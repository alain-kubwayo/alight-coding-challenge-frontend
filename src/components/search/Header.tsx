...
const Header = () => {
  const url: string =
    "https://lh3.googleusercontent.com/ogw/AF2bZyhkykt42Oz6ooTrmwbHb7Kdf03ZL2VCwO9qly5ghQ3sFYc=s32-c-mo";
  ...
  return (
    <div className="sticky top-0 z-50 flex justify-between bg-white">
      ...
      <div className="flex flex-wrap items-center justify-end space-x-3 navbar">
        ...
        <div className="p-1 rounded-full cursor-pointer hover:bg-gray-100">
          <div className="relative  rounded-full w-[30px] h-[30px] border border-gray-300">
            <img src={url} alt="Google Image" className="object-cover w-full h-full rounded-full" />
          </div>
        </div>
      </div>
    </div>
